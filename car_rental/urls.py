...
from .views import CarImageListCreateView, CarImageRetrieveDeleteView, CarListCreateView, CarDetailView, CheckAvailabilityView,AddFeatureToCarView, FeatureCreateListView
...
urlpatterns = [
    ...
    path('cars/features/', FeatureCreateListView.as_view(), name='add new feature'),
